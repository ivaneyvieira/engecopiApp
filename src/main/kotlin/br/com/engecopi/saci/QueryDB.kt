...
open class QueryDB(val driver: String, val url: String, val username: String, val password: String) {
  ...
  fun <V> withConnection(runnable: StatementRunnableWithResult) = sql2o.withConnection<V>(runnable)
