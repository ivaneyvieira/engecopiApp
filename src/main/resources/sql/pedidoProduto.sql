<<<<<<< HEAD
SELECT E.storeno AS storeno, E.ordno AS ordno, E.prdno AS prdno, E.grade AS grade,
       qtty / 1000 AS quant, IF(I.last_cost = 0, I.cm_varejo_otn, I.last_cost) / 10000 AS preco,
...
WHERE E.storeno = :storeno AND E.ordno = :ordno AND O.status IN (1, 4)
