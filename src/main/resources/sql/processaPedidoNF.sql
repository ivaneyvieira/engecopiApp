...
SELECT @INVNO                                                             AS                        invno,
       ...
       0                                                                  AS                        base_ipi,
       0                                                                  AS                        aliq,
       IF(@TIPO_NOTA = 7, T.cfopEC, T.cfopEV)                             AS                        cfo,
       0                                                                  AS                        nfNfno,
...
SELECT @INVNO                                 AS invno,
       ...
       cost * 100                             AS cost4,
       0                                      AS icmsAliq,
       IF(@TIPO_NOTA = 7, T.cfopEC, T.cfopEV) AS cfop,
       0                                      AS auxLong3,
       0                                      AS auxLong4,
       0                                      AS auxLong5,
       0                                      AS auxMy1,
...
SELECT @XANO                                                              AS xano,
       ...
       0                                                                  AS vol_no,
       0                                                                  AS vol_qtty,
       IF(@TIPO_NOTA = 7, T.cfopSC, T.cfopSV)                             AS cfo,
       0                                                                  AS invno,
       0                                                                  AS cfo2,
       0                                                                  AS auxLong1,
       0                                                                  AS auxLong2,
       ...
       ''                                                                 AS vol_make,
       ''                                                                 AS vol_kind,
       IF(@OBS = '66', @OBS, CAST(CONCAT(@OBS, ' ', fabricante) AS CHAR)) AS remarks,
       ''                                                                 AS padbyte,
       ''                                                                 AS print_remarks,
       ''                                                                 AS remarksCancel,
       @DOC                                                               AS c1,
